// The single import for every spec: `test` (extended with the auth-seeded
// `page` + all page-object and step fixtures) and `expect`. Specs import from
// here, NEVER from @playwright/test, and receive their step classes via DI —
// zero `new` in specs.
//
