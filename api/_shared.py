    ...
    *,
    ...
    parts = [
        ...
        (
            ...
            "replaces this placeholder instead of creating a duplicate (#208)._"
        ),
    ]
    if excerpt:
...
def select_followup_source(
    ...
    On ``DONE_SPLIT`` threads the source is ``split_stories``; on
    ...
    if status == ThreadStatus.DONE_SPLIT:
        return runner.get_split_stories_and_context(thread_id)
